...
export const ProductItem = ({ product, className, onAdd }) => {
    ...
    return <div className={"product " + className}>
        ...
        <div className="quantity_inner">        
            <button className="bt_minus" onClick={onHandlerMinus}>
                <svg viewBox="0 0 24 24"><line x1="5" y1="12" x2="19" y2="12"></line></svg>
            </button>
            <input type="text" readOnly value={counter} className={"quantity " + className} data-max-count="20" />
            <button onClick={onHandlerPlus} className="bt_plus">
